...
function storageKey(key) {
  ...
  const personalKeys = ["llmRecords", "llmPrompts", "installedTools", "languageSettings"];
  
  return user && personalKeys.includes(key) ? `aiGuide:${user}:${key}` : key;
}
...
const languageLabels = {
  javascript: "HTML/CSS/JavaScript", python: "Python", java: "Java", csharp: "C#", c: "C/C++", sql: "SQL"
}
;
...
const osCompatibility = {
 ...
 "mac"], "Ubuntu Desktop": ["linux"], GCC: ["linux", "mac"]
}
;

const toolCategoryLabels = {
  ide: "IDE / 개발환경", web: "웹 / 앱 개발", ai: "AI", review: "코드 리뷰 / 품질 개선", test: "테스트 / 자동화", data: "SQL / 데이터 작업",
 ui: "UI / 프론트 개발", collab: "협업", embedded: "임베디드 / 하드웨어", media: "그래픽 / 미디어", security: "보안", game: "게임 / 기타"
}
;

const toolCategoryOrder = ["ide", "web", "ai", "data", "ui", "collab", "review", "test", "security", "embedded",
 "media", "game"];

const languageOptions = ["C", "C++", "C#", "Java", "Python", "HTML/CSS/JavaScript", "SQL"];
...
const toolboxStages = [
{
 ...
 "MySQL"], ai: ["ChatGPT", "GitHub Copilot", "Gemini", "Claude", "OpenAI Codex"]
}
,
{
  title: "2단계: 개발자 기본 세팅", subtitle: "과제와 개인 프로젝트가 가능한 수준", goal: "프로젝트 관리, Git 사용, 리눅스 환경 익숙해지기", dev: ["IntelliJ IDEA Community",
 "PyCharm Community", "MinGW-w64", "GCC", "Ubuntu Desktop", "WSL2 + Ubuntu", "Git", "GitHub", "GitHub Desktop", "Burp Suite Community",
 "Node.js", "React", "Vue", "pandas", "scikit-learn", "PostgreSQL"], ai: ["Continue", "Cursor", "Codeium / Windsurf",
 "Phind", "Gemma", "Google Stitch"]
}
,
{
  title: "3단계: 실전 개발 세팅", subtitle: "취업, 팀 프로젝트, 고급 개발에 선택적으로 추가", goal: "협업, 테스트 자동화, 실무 툴 경험", dev: ["Unity",
"Playwright", "Testim", "SonarQube", "DataGrip", "TablePlus", "Docker", "Firebase", "React Native", "Flutter", "PyTorch", "TensorFlow",
"Nginx", "Amazon Web Services", "Kubernetes", "Arduino", "FreeRTOS", "MongoDB", "Photoshop", "Blender", "OWASP ZAP", "Wireshark",
"Nmap", "Metasploit Framework", "Notion Desktop", "Slack", "Microsoft Teams", "Confluence"], ai: ["Ollama", "Amazon Q Developer",
"Snyk Code / DeepCode", "Qodo / CodiumAI", "Figma AI", "Uizard", "Notion AI"]
}
...
function getLanguageScore(tool, goal) {
  ...
  const prioritySets = [
  {
    words: ["웹", "웹개발", "웹 개발", "사이트", "html", "css", "프론트", "프론트엔드"], order: ["Visual Studio Code", "Google Chrome"]
  }
  ,
  {
 ...
 "Visual Studio Code"]
  ...
  ,
  {
    words: ["자바", "java"], order: ["JDK", "IntelliJ IDEA Community", "Eclipse IDE", "Visual Studio Code"]
  }
  ,
  {
    words: ["자바스크립트", "javascript", "js"], order: ["Visual Studio Code", "Cursor", "GitHub Copilot"]
  }
  ,
  {
    words: ["sql", "쿼리", "데이터베이스", "db"], order: ["MySQL", "PostgreSQL", "ChatGPT"]
  }
...
function parseGoal(goal) {
  ...
  [
  {
    words: ["웹", "앱", "사이트", "프론트", "html", "css", "javascript", "react", "vue", "node", "api"], fields: ["web"],
 languages: ["javascript"], categories: ["ui"]
  }
  ,
  {
    words: ["인공지능", "ai", "머신러닝", "딥러닝", "llm", "챗봇", "jupyter", "pandas", "pytorch", "tensorflow"], fields: ["ai",
 "data"], languages: ["python"], categories: ["ai", "data", "language"]
  }
  ,
  {
    words: ["보안", "취약점", "침투", "해킹", "네트워크", "패킷", "ctf", "burp", "wireshark"], fields: ["security"], categories: ["security"]
  }
  ,
  {
    words: ["협업", "팀", "깃", "github", "깃허브", "문서", "회의", "이슈", "버전관리", "slack", "notion", "teams", "confluence"],
 fields: ["collab"], categories: ["collab"]
  }
  ,
  {
    words: ["데이터베이스", "sql", "db", "쿼리", "mysql", "postgresql", "mongodb"], fields: ["database", "data"], languages: ["sql"],
 categories: ["data"]
  }
  ,
  {
    words: ["시스템", "인프라", "리눅스", "linux", "ubuntu", "wsl", "nginx", "aws", "클라우드", "kubernetes"], fields: ["system"],
 categories: ["system"]
  }
  ,
  {
    words: ["임베디드", "하드웨어", "arduino", "센서", "rtos", "freertos", "펌웨어", "iot"], fields: ["embedded"], languages: ["c"],
 categories: ["language", "system"]
  }
  ,
  {
    words: ["그래픽", "미디어", "2d", "3d", "렌더링", "photoshop", "blender", "모델링"], fields: ["media"], categories: ["ui",
 "game"]
  }
  ,
  {
  ...
  ,
  {
    words: ["ui", "화면", "디자인", "프론트", "프로토타입", "와이어프레임", "stitch", "스티치"], fields: ["web", "app"], categories: ["ui"]
  }
